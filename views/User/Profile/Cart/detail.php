  ...
  <?php $this->load->view('User/navbar')?>
          ...
          <div class="card-content" style="padding:5px;">
            ...
            <div class="row valign-wrapper" style="margin-bottom:10px;">
              ...
              <div class="col s9" style="float:left;">
                ...
                <p class="truncate orange-text" style="line-height:15px; font-size:12px;"><?php echo $keranjang->nama_toko?></p>
            ...
            <div class="row" style="margin-bottom:0px;">
              <?php if($keranjang->status < 2 && $jmlNego->jml < 6){?>
              <div class="col s6" style="padding-right:2px;">
              ...
              <div class="col s6" style="padding-left:2px;">
                 <a href="<?=Base_url()?>profile/transaksi/keranjang/pembayaran/<?php echo $keranjang->id?>" class="btn waves-effect waves-light" style="width:100%; background-color:#fe6719;">Pembayaran</a>
              </div>
              <?php }?>
            </div>
    ...
    <div id="tawar1" class="modal">
      <div class="modal-content" style="padding:10px 0 0 0;">
        <div class="row">
          <form class="col s12" method="POST" action="<?=Base_url()?>Product/postUpdateNego">          
            <div class="row" style="margin-bottom: 10px;">
              <div class="input-field col s6 m6" style="padding-left:0px;">
                <input type="text" id="jumlah_produk" name="qty" class="validate" style="margin-bottom:0px; height:20px;">
                <input type="hidden" id="a" name="id_produk" value="<?php echo $keranjang->id_datajual?>" class="validate" style="margin-bottom:0px; height:20px;">
                <input type="hidden" id="b" name="id_cart" value="<?php echo $keranjang->id?>" class="validate" style="margin-bottom:0px; height:20px;">
                <label for="jumlah_produk">Jumlah Produk</label>
              </div>
              <div class="input-field col s6 m6" style="padding-right:0px;">
                <input type="text" id="harga_satuan" name="price" class="validate" style="margin-bottom: 0px; height: 20px;">
